...
public class UserDaoJdbc implements UserDao {
	...
	static final Logger LOG = LoggerFactory.getLogger(UserDaoJdbc.class);
	...
	public List<User> retrieve(Search vo) {
		...
		sb.append("  			WHERE reg_dt > to_date('19700101','yyyymmdd')                                        \n");
		sb.append("  			--Search Condition                                          \n");
		sb.append(param.toString());		
//		sb.append("  			ORDER BY reg_dt DESC                                        \n");
//index 튜닝
//		CREATE INDEX IX_USERS_REG_DT
//		ON USERS( REG_DT desc);		
