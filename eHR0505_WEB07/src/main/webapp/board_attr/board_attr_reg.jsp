    ...
    <div class="container">
        ...
        <form class="form-horizontal" name="boardEditFrm" id="boardEditFrm"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="readCnt" id="readCnt" placeholder="조회수"  disabled="disabled">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="regId" class="col-sm-2 control-label">등록자 아이디</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="regId" id="regId"
                        placeholder="등록자 아이디" disabled="disabled">
                </div>
            </div>
            <div class="form-group">
                <label for="regDt" class="col-sm-2 control-label">등록일</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="regDt" id="regDt" placeholder="등록일" disabled="disabled">
                </div>
            </div>
            <div class="form-group">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="form-horizontal" action="${context}/file/do_save.do" name="saveFileForm" 
                    id="saveFileForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" name="work_div"   id="work_div"  value="com">
                        <input type="hidden" class="form-control" name="attrFileId" id="attrFileId" >
