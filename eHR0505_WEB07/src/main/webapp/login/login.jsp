		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" name="loginForm" id="loginForm" 
				    ...
				    <div class="col-lg-10"></div>
				    <div class="col-lg-10"></div>
					<div class="wrap-input100 validate-input" data-validate = "Valid u_id is required">
						<input class="input100" type="text" name="u_id" id="u_id" placeholder="아이디">
						<spring:hasBindErrors name="login">
            				<c:if test="${errors.hasFieldErrors('u_id') }">
               					<strong>${errors.getFieldError('u_id').defaultMessage }</strong>
							</c:if>
